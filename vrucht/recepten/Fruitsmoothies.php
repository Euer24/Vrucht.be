    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-4 border-start">
                <h2>Hallo Welkom bij vrucht!</h2>
                <p>Je vind hier de lekkerste en gezondste gerechten</p>
                <ul>
                    <li><a href="/vrucht/recepten">Fruitsmoothies</a></li>
                    <li><a href="/vrucht/fruit">Passievrucht/Mango Cheesecake</a></li>
                    <li><a href="/vrucht/fruitsoorten">Bosbessen-Havermout Muffins</a></li>
                    <li><a href="/vrucht/fruitsoorten">Fruitsoorten</a></li>
                </ul>
            </div>
        </div>
    </div>
